            ...
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <p class="description mt-3">
                  I built a ridiculously over-engineered CatFacts service in
                  Golang as an example of a clean and maintainable web service.
                  Then I deployed it to Google Cloud via Kubernetes.
                </p>
          ...
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <p class="description mt-3">
                  We wrote a Golang CLI that lets you export your Cloudflare
                  resources into Terraform config and state files.
                </p>
          ...
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <p class="description mt-3">
                  We wrote a worker and put it in front of api.cloudflare.com
                  and dash.cloudflare.com to handle graceful TLS deprecation and
